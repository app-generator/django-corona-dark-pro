# [Django Dashboard Corona PRO](https://appseed.us/admin-dashboards/django-dashboard-corona-dark-pro)

> Commercial product - **Django Dashboard** coded on top of **Corona Dashboard PRO** crafted by **BootstrapDash** - Features:

- Sample UI Kit: **Corona Dashboard PRO** provided by **BootstrapDash**
...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-django-dashboard-corona-dark-pro.git
$ cd priv-django-dashboard-corona-dark-pro
$
...
---
[Django Dashboard Corona PRO](https://appseed.us/admin-dashboards/django-dashboard-corona-dark-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
